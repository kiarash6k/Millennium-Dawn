...
- [Triggers](#triggers)
	...
	- [Triggers for scope FACTION](#triggers-for-scope-faction)
	- [Triggers for scope INDUSTRIAL\_ORG](#triggers-for-scope-industrial_org)
	- [Triggers for scope OPERATION](#triggers-for-scope-operation)
	- [Triggers for scope PURCHASE\_CONTRACT](#triggers-for-scope-purchase_contract)
	- [Triggers for scope RAID\_INSTANCE](#triggers-for-scope-raid_instance)
	- [Triggers for scope SPECIAL\_PROJECT](#triggers-for-scope-special_project)
	...
	- [advisor\_can\_be\_fired](#advisor_can_be_fired)
	...
	- [all\_military\_industrial\_organization](#all_military_industrial_organization)
	...
	- [all\_purchase\_contracts](#all_purchase_contracts)
	- [all\_scientists](#all_scientists)
	...
	- [any\_military\_industrial\_organization](#any_military_industrial_organization)
	...
	- [any\_other\_country\_of](#any_other_country_of)
		- [Example](#example-6)
	- [any\_other\_country\_with\_original\_tag\_of](#any_other_country_with_original_tag_of)
		- [Example](#example-7)
	- [any\_owned\_state](#any_owned_state)
	- [any\_province\_building\_level](#any_province_building_level)
	- [any\_purchase\_contract](#any_purchase_contract)
	- [any\_scientist](#any_scientist)
	- [any\_state](#any_state)
	- [any\_state\_division](#any_state_division)
	- [any\_state\_in](#any_state_in)
	- [any\_state\_of](#any_state_of)
		- [Example](#example-8)
	...
	- [building\_count\_trigger](#building_count_trigger)
	- [buyer](#buyer)
	- [can\_assign\_supportive\_scientist\_to\_faction](#can_assign_supportive_scientist_to_faction)
	- [can\_be\_country\_leader](#can_be_country_leader)
	- [can\_build\_railway](#can_build_railway)
	- [can\_construct\_building](#can_construct_building)
	- [can\_declare\_war\_on](#can_declare_war_on)
	- [can\_research](#can_research)
	- [can\_select\_trait](#can_select_trait)
	- [career\_profile\_check\_medal](#career_profile_check_medal)
	- [career\_profile\_check\_playthrough\_ratio](#career_profile_check_playthrough_ratio)
	- [career\_profile\_check\_playthrough\_value](#career_profile_check_playthrough_value)
	- [career\_profile\_check\_points](#career_profile_check_points)
	- [career\_profile\_check\_ratio](#career_profile_check_ratio)
	- [career\_profile\_check\_ribbon](#career_profile_check_ribbon)
	- [career\_profile\_check\_value](#career_profile_check_value)
	- [career\_profile\_has\_player\_flag](#career_profile_has_player_flag)
	- [career\_profile\_set\_temp\_playthrough\_variable](#career_profile_set_temp_playthrough_variable)
	- [career\_profile\_set\_temp\_variable](#career_profile_set_temp_variable)
	...
	- [collection\_contains](#collection_contains)
		- [Example](#example-9)
	- [collection\_size](#collection_size)
		- [Example](#example-10)
	...
	- [compare\_ideology\_with\_faction](#compare_ideology_with_faction)
		- [Example](#example-11)
	- [compare\_intel\_with](#compare_intel_with)
	- [compliance](#compliance)
	- [compliance\_speed](#compliance_speed)
	- [conscription\_ratio](#conscription_ratio)
	- [contract\_contains\_equipment](#contract_contains_equipment)
	...
	- [deal\_completion](#deal_completion)
	...
	- [division\_has\_battalion\_in\_template](#division_has_battalion_in_template)
	- [division\_has\_majority\_template](#division_has_majority_template)
	...
	- [exists](#exists)
	- [faction\_goal\_fulfillment](#faction_goal_fulfillment)
		- [Examples](#examples-1)
	- [faction\_influence\_rank](#faction_influence_rank)
		- [Examples](#examples-2)
	- [faction\_influence\_ratio](#faction_influence_ratio)
		- [Examples](#examples-3)
	- [faction\_influence\_score](#faction_influence_score)
		- [Examples](#examples-4)
	- [faction\_manifest\_fulfillment](#faction_manifest_fulfillment)
		- [Examples](#examples-5)
	- [faction\_power\_projection](#faction_power_projection)
		- [Examples](#examples-6)
	- [faction\_upgrade\_level](#faction_upgrade_level)
		- [Examples](#examples-7)
	- [fastest\_unit](#fastest_unit)
	- [fighting\_army\_strength\_ratio](#fighting_army_strength_ratio)
	...
	- [get\_supply\_vehicles\_temp](#get_supply_vehicles_temp)
	...
	- [has\_active\_rule](#has_active_rule)
		- [Examples](#examples-8)
	- [has\_added\_tension\_amount](#has_added_tension_amount)
	- [has\_advisor\_role](#has_advisor_role)
	...
	- [has\_any\_power\_balance](#has_any_power_balance)
	...
	- [has\_artillery\_ratio](#has_artillery_ratio)
	...
	- [has\_bombing\_war\_support](#has_bombing_war_support)
	...
	- [has\_breakthrough\_points](#has_breakthrough_points)
	...
	- [has\_casualties\_war\_support](#has_casualties_war_support)
	...
	- [has\_completed\_custom\_achievement](#has_completed_custom_achievement)
	- [has\_completed\_faction\_goal](#has_completed_faction_goal)
		- [Examples](#examples-9)
	- [has\_completed\_focus](#has_completed_focus)
	- [has\_completed\_subdoctrine](#has_completed_subdoctrine)
	- [has\_completed\_track](#has_completed_track)
	- [has\_contested\_owner](#has_contested_owner)
		- [Example](#example-12)
	- [has\_convoys\_war\_support](#has_convoys_war_support)
	...
	- [has\_enemy\_naval\_control](#has_enemy_naval_control)
		- [Examples](#examples-10)
	- [has\_enough\_influence\_for\_leadership](#has_enough_influence_for_leadership)
		- [Examples](#examples-11)
	- [has\_equipment](#has_equipment)
	- [has\_event\_target](#has_event_target)
	- [has\_facility\_specialization](#has_facility_specialization)
	- [has\_faction\_goal](#has_faction_goal)
		- [Examples](#examples-12)
	- [has\_faction\_military\_unlocked](#has_faction_military_unlocked)
		- [Examples](#examples-13)
	- [has\_faction\_research\_unlocked](#has_faction_research_unlocked)
		- [Examples](#examples-14)
	- [has\_faction\_template](#has_faction_template)
	...
	- [has\_industry\_to\_become\_leader](#has_industry_to_become_leader)
	...
	- [has\_manpower\_to\_become\_leader](#has_manpower_to_become_leader)
		- [Examples](#examples-17)
	- [has\_market\_access\_with](#has_market_access_with)
	- [has\_mastery](#has_mastery)
	- [has\_mastery\_level](#has_mastery_level)
	- [has\_max\_planning](#has_max_planning)
	- [has\_military\_access\_to](#has_military_access_to)
	- [has\_military\_industrial\_organization](#has_military_industrial_organization)
	- [has\_mined](#has_mined)
	- [has\_mines](#has_mines)
	- [has\_mio\_equipment\_type](#has_mio_equipment_type)
	- [has\_mio\_flag](#has_mio_flag)
	- [has\_mio\_number\_of\_completed\_traits](#has_mio_number_of_completed_traits)
	- [has\_mio\_policy](#has_mio_policy)
	- [has\_mio\_policy\_active](#has_mio_policy_active)
	- [has\_mio\_research\_category](#has_mio_research_category)
	- [has\_mio\_size](#has_mio_size)
	- [has\_mio\_trait](#has_mio_trait)
	- [has\_nationality](#has_nationality)
	- [has\_naval\_control](#has_naval_control)
		- [Examples](#examples-18)
	- [has\_naval\_invasion\_against\_state](#has_naval_invasion_against_state)
	...
	- [has\_offensive\_war\_without\_friend](#has_offensive_war_without_friend)
	- [has\_officer\_name](#has_officer_name)
	...
	- [has\_power\_balance](#has_power_balance)
	- [has\_power\_balance\_modifier](#has_power_balance_modifier)
	- [has\_project\_flag](#has_project_flag)
	...
	- [has\_resources\_in\_collection](#has_resources_in_collection)
	- [has\_resources\_in\_country](#has_resources_in_country)
	- [has\_resources\_rights](#has_resources_rights)
	- [has\_rule](#has_rule)
	- [has\_scientist\_level](#has_scientist_level)
	- [has\_scientist\_specialization](#has_scientist_specialization)
	- [has\_shine\_effect\_on\_focus](#has_shine_effect_on_focus)
		- [Example](#example-13)
	...
	- [has\_subdoctrine\_in\_track](#has_subdoctrine_in_track)
	- [has\_subject](#has_subject)
	- [has\_tactic](#has_tactic)
	- [has\_tech](#has_tech)
	...
	- [has\_war\_with\_major](#has_war_with_major)
	- [has\_war\_with\_wargoal\_against](#has_war_with_wargoal_against)
	- [has\_wargoal\_against](#has_wargoal_against)
	- [hidden\_trigger](#hidden_trigger)
	- [ic\_ratio](#ic_ratio)
	- [ideology\_support\_trigger](#ideology_support_trigger)
	- [if](#if)
	- [impassable](#impassable)
	- [intel\_level\_over](#intel_level_over)
	- [is\_active\_decryption\_bonuses\_enabled](#is_active_decryption_bonuses_enabled)
	- [is\_active\_scientist](#is_active_scientist)
	...
	- [is\_embargoed\_by](#is_embargoed_by)
	- [is\_embargoing](#is_embargoing)
	...
	- [is\_hired\_as\_advisor](#is_hired_as_advisor)
	...
	- [is\_leading\_army\_in\_province](#is_leading_army_in_province)
	...
	- [is\_major](#is_major)
	- [is\_military\_industrial\_organization](#is_military_industrial_organization)
	- [is\_mio\_assigned\_to\_task](#is_mio_assigned_to_task)
	- [is\_mio\_available](#is_mio_available)
	- [is\_mio\_trait\_available](#is_mio_trait_available)
	- [is\_mio\_trait\_completed](#is_mio_trait_completed)
	- [is\_mio\_visible](#is_mio_visible)
	...
	- [is\_on\_same\_continent\_as](#is_on_same_continent_as)
	- [is\_one\_state\_island](#is_one_state_island)
	...
	- [is\_power\_balance\_in\_range](#is_power_balance_in_range)
	- [is\_power\_balance\_side\_active](#is_power_balance_side_active)
	...
	- [is\_scientist\_injured](#is_scientist_injured)
	- [is\_special\_project\_being\_researched](#is_special_project_being_researched)
	- [is\_special\_project\_completed](#is_special_project_completed)
	...
	- [is\_unit\_template\_reserves](#is_unit_template_reserves)
	...
	- [longest\_war\_length](#longest_war_length)
	...
	- [num\_battalions\_in\_states](#num_battalions_in_states)
	- [num\_divisions](#num_divisions)
	- [num\_divisions\_in\_states](#num_divisions_in_states)
	...
	- [num\_nukes\_being\_dropped](#num_nukes_being_dropped)
	- [num\_nukes\_left\_to\_drop](#num_nukes_left_to_drop)
	...
	- [num\_of\_career\_profile\_points](#num_of_career_profile_points)
	...
	- [num\_planes\_stationed\_in\_regions](#num_planes_stationed_in_regions)
	...
	- [owns\_any\_state\_of](#owns_any_state_of)
	- [owns\_state](#owns_state)
	- [pc\_current\_score](#pc_current_score)
	- [pc\_does\_state\_stack\_demilitarized](#pc_does_state_stack_demilitarized)
	- [pc\_does\_state\_stack\_dismantled](#pc_does_state_stack_dismantled)
	- [pc\_is\_forced\_government](#pc_is_forced_government)
	- [pc\_is\_forced\_government\_by](#pc_is_forced_government_by)
	- [pc\_is\_forced\_government\_to](#pc_is_forced_government_to)
	- [pc\_is\_liberated](#pc_is_liberated)
	- [pc\_is\_loser](#pc_is_loser)
	- [pc\_is\_on\_same\_side\_as](#pc_is_on_same_side_as)
	- [pc\_is\_on\_winning\_side](#pc_is_on_winning_side)
	- [pc\_is\_puppeted](#pc_is_puppeted)
	- [pc\_is\_puppeted\_by](#pc_is_puppeted_by)
	- [pc\_is\_state\_claimed](#pc_is_state_claimed)
	- [pc\_is\_state\_claimed\_and\_taken\_by](#pc_is_state_claimed_and_taken_by)
	- [pc\_is\_state\_claimed\_by](#pc_is_state_claimed_by)
	- [pc\_is\_state\_outside\_influence\_for\_winner](#pc_is_state_outside_influence_for_winner)
	- [pc\_is\_winner](#pc_is_winner)
	- [pc\_total\_score](#pc_total_score)
	- [pc\_turn](#pc_turn)
	- [phase](#phase)
	...
	- [power\_balance\_daily\_change](#power_balance_daily_change)
	- [power\_balance\_value](#power_balance_value)
	- [power\_balance\_weekly\_change](#power_balance_weekly_change)
	- [print\_variables](#print_variables)
	- [province\_vp](#province_vp)
	...
	- [resource\_count\_trigger](#resource_count_trigger)
	- [round\_temp\_variable](#round_temp_variable)
	- [scope\_exists](#scope_exists)
	- [seller](#seller)
	...
	- [temperature](#temperature)
	- [threat](#threat)
	- [unit\_organization](#unit_organization)
	- [unit\_strength](#unit_strength)
	- [war\_length\_with](#war_length_with)
